...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { choice: @choice.choice, correct: @choice.correct, explaination: @choice.explaination, question_id: @choice.question_id }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { choice: @choice.choice, correct: @choice.correct, explaination: @choice.explaination, question_id: @choice.question_id }
    assert_redirected_to choice_path(assigns(:choice))
  end
